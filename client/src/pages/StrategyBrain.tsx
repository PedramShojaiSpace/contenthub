          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                rows={4}
                placeholder="e.g. Ready to reclaim your energy? Join the Lights On course at urbanmonk.com/lights-on and get the exact protocols Dr. Pedram Shojai uses with his patients."
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="https://urbanmonk.com/lights-on"
                className="bg-background border-border text-sm"
              />
            </div>

...
{
  "underlordPrompt": "A detailed Descript Underlord prompt for an AVATAR-LED video. CRITICAL RULE — THIS IS AN AVATAR VIDEO: The main presenter (Dr. Pedram Shojai avatar) must remain on screen for the majority of the video. B-roll is used for TASTEFUL CUTAWAYS only — to visually reinforce specific facts, statistics, or concepts being discussed. DO NOT cover the avatar continuously. The avatar should be visible for at least 60-70% of the total video duration. B-ROLL CUTAWAY RULES: (1) Cut to B-roll ONLY when the speaker mentions a specific visual concept, statistic, body part, food, nature scene, or scientific concept that benefits from a visual. (2) Each B-roll cutaway should last 3-6 seconds maximum, then CUT BACK to the avatar. (3) Space cutaways naturally — roughly every 20-40 seconds, not every 5-8 seconds. (4) NEVER use B-roll during the intro, conclusion, or any moment where the presenter is making a direct personal connection with the viewer. (5) NEVER REUSE THE SAME CLIP. CLEANUP: Remove all filler words (um, uh, like, you know) and long pauses over 0.5 seconds. CAPTIONS: Add auto-captions in white text, lower third position. MUSIC: Add subtle ambient background music at -18dB (nature/meditation style). B-ROLL CONTENT: Describe specific stock footage clips that directly match the concept being spoken about at that moment — anatomy visuals, healthy food, nature, science imagery, wellness scenes. Each clip must be unique. END CARD: Add a 5-second end card with white text on dark background: 'Learn More at theurbanmonk.com'",

...
{
  "underlordPrompt": "A detailed Descript Underlord prompt. MANDATORY B-ROLL RULES: (1) Place a new B-roll clip at EVERY 5 to 8 seconds — non-negotiable. No single shot may remain on screen longer than 8 seconds. Cut to a new clip immediately at the 8-second mark throughout the ENTIRE video from start to finish with zero gaps. (2) NEVER REUSE THE SAME CLIP — every single B-roll clip must be a DIFFERENT, UNIQUE shot. Do not repeat any clip that has already appeared in this video. Search for fresh stock footage for each placement. Variety is mandatory: alternate between close-ups, wide shots, aerial views, human subjects, nature, and abstract visuals. (3) SILENCE REMOVAL: Trim all trailing silence at the end of the video — the audio should end cleanly with no dead air after the last spoken word. Remove any pause longer than 0.3 seconds at the end. VOICE: Generate voiceover using Pedram's AI voice clone named 'Pedram FOR GUT COURSE READ'. CLEANUP: Remove all filler words (um, uh, like, you know) and long pauses over 0.3 seconds throughout. CAPTIONS: Add auto-captions in white text, lower third position. MUSIC: Add subtle ambient background music at -18dB (nature/meditation style). B-ROLL CONTENT: Describe specific, varied stock footage clips that match the content being discussed — nature, science, wellness, people meditating, healthy food, anatomy visuals, urban environments, etc. Each clip description must be unique and different from all others in this list. END CARD: Add a 5-second end card with white text on dark background: 'Learn More at theurbanmonk.com'",

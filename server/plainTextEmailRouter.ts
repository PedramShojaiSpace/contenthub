...
export const plainTextEmailRouter = router({
  // Generate a plain-text email from episode details
...
- The email should feel like Pedram personally reached out, not a newsletter blast
- Reference the content genuinely — what it means, why it matters, what the reader will get from it
- End with a P.S. that adds one extra reason to watch (curiosity, personal story, or surprising fact)

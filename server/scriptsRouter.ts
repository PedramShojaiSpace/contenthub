...
export const scriptsRouter = router({
  ...
  seedVideos: protectedProcedure.mutation(async () => {
    ...
    const seeds = [
      ...
      { priority: 17, title: "Lights On Course: What You Get for $369/Year", competitorAngle: "Direct conversion video — positions value vs. Mindvalley/Sounds True", estimatedDurationMin: 8, notes: "Testimonial-style + curriculum walkthrough. Show the community, the courses, the live calls. Link: go.theurbanmonk.com/something-has-been-stolen-from-you-lo-webinar-1" },
...
#selfhealing #innerchild #attachmentstyle #nervoussystem #taoism #urbanmonk #holistichealth` },
  ...
  seedLinkedIn: protectedProcedure.mutation(async () => {
    ...
    const linkedInSeeds = [
      ...
      { priority: 10, title: "Lights On Course: what $369/year gets you (and why I priced it this way)", notes: "Transparent pricing post. Cover: what's included, why the price, the mission behind it. Drive to Lights On Course webinar.", competitorAngle: "Mindvalley charges $500+/year — Lights On is the accessible, results-driven alternative" },
    ];
  ...
  seedX: protectedProcedure.mutation(async () => {
    ...
    const xSeeds = [
      ...
      { priority: 10, title: "Thread: Lights On Course — what I built and why", notes: "Founder story thread. Why I built it, what's inside, who it's for, the $369/year price and why. Transparent and personal.", competitorAngle: "Authentic founder story — no competitor can replicate" },
    ];

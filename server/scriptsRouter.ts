...
export const scriptsRouter = router({
  ...
  seedVideos: protectedProcedure.mutation(async () => {
    ...
    const seeds = [
      ...
      { priority: 17, title: "The Urban Monk Academy: What You Get for $297/Year", competitorAngle: "Direct conversion video — positions value vs. Mindvalley/Sounds True", estimatedDurationMin: 8, notes: "Testimonial-style + curriculum walkthrough. Show the community, the courses, the live calls." },
...
#selfhealing #innerchild #attachmentstyle #nervoussystem #taoism #urbanmonk #holistichealth` },
  ...
  seedLinkedIn: protectedProcedure.mutation(async () => {
    ...
    const linkedInSeeds = [
      ...
      { priority: 10, title: "The Urban Monk Academy: what $297/year gets you (and why I priced it this way)", notes: "Transparent pricing post. Cover: what's included, why the price, the mission behind it. Drive to Academy.", competitorAngle: "Mindvalley charges $500+/year — Urban Monk is the accessible alternative" },
    ];
  ...
  seedX: protectedProcedure.mutation(async () => {
    ...
    const xSeeds = [
      ...
      { priority: 10, title: "Thread: The Urban Monk Academy — what I built and why", notes: "Founder story thread. Why I built it, what's inside, who it's for, the $297/year price and why. Transparent and personal.", competitorAngle: "Authentic founder story — no competitor can replicate" },
    ];

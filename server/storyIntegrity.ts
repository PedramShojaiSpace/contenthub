...
export function buildStoryIntegrityBlock(mode: StoryMode): string {
  const shared = [
    ...
    "  This holds EVEN IF the material appears verbatim in the provided corpus.",
    ...
    "",
    "TESTIMONIALS IN THE CORPUS — READ THIS CAREFULLY.",
    "The corpus may contain customer testimonials: real named people with quoted",
    "outcomes (e.g. a named graduate describing a 40-year condition resolving).",
    "Those are PROOF THAT THE OFFER WORKS. They are NOT narrative raw material.",
    "Treat them as aggregate evidence of outcome, never as a story to retell:",
    '  ALLOWED:   "people who have done this work report their brain fog lifting"',
    '  ALLOWED:   "this is the most common outcome clients describe"',
    '  FORBIDDEN: naming the person, quoting them, or narrating their case —',
    "             even though their name and words are right there in the corpus.",
    "A testimonial lifted into a script reads to a listener as a patient story the",
    "practitioner is telling. It will be rejected. Aggregate instead of retelling.",
  ];

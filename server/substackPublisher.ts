...
export interface SubstackPostInput {
  ...
  sendEmail?: boolean;
  /** Audience: 'everyone' (free + paid) or 'only_paid' (paid subscribers only). Default: 'everyone'.
   * NOTE: Confirmed valid values via live API probe (Jul 2026): 'everyone' and 'only_paid'. */
